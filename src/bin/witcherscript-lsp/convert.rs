...
pub(crate) fn base_script_conflict_code_actions(
    ...
    for diagnostic in diagnostics {
        ...
        // A whole-file request carries many conflict diagnostics for one directory.
...
// Show the directory relative to its workspace root; the command keeps the absolute path.
